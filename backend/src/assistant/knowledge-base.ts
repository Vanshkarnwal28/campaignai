...
export const CAMPAIGNAI_CHUNKS: KnowledgeChunk[] = [
  // --- 1. Account & Authentication ---
  {
    ...
    content: 'To create a new CampaignAI account, visit the Registration page. You can sign up using your email and password or perform single-click sign-up with Google OAuth. Upon registration, you will be prompted to set up your business profile or run the Onboarding Wizard.',
    steps: [
  ...
  },
  {
    ...
    content: 'Existing users can log into CampaignAI by entering their registered email and password on the Login page, or by choosing Google Sign In.',
    steps: [
      'Navigate to the Login page (/login).',
      'Enter your registered Email Address and Password.',
      'Click "Log In" or select "Continue with Google".',
      'You will be redirected straight to your CampaignAI Dashboard.'
    ],
  ...
  },
  {
    ...
    content: 'If you forgot your password, you can reset it via the Forgot Password option on the Login page. CampaignAI sends a password reset link to your registered email address via Firebase Authentication.',
    steps: [
  ...
  },
  {
    ...
    content: 'Google Sign In allows fast, passwordless access to CampaignAI using your Google account via Firebase OAuth integration.',
    steps: [
      ...
      'CampaignAI will create or authenticate your user session automatically.'
    ],
  ...
  },
  {
    ...
    content: 'System administrators can access the CampaignAI Admin Portal to view system-wide metrics, manage registered users, monitor business profiles, and handle escalated support tickets.',
    steps: [
  ...
  // --- 3. Business Onboarding ---
  {
    ...
    content: 'During Business Onboarding, CampaignAI uses an interactive 20-question chatbot wizard to gather comprehensive information about your business: business name, category, products/services, target audience demographics, location, monthly budget, brand tone, competitors, USP, and goals. This data powers AI ad generation, content calendar plans, and budget optimization.',
    steps: [
  ...
  // --- 4. Meta Business Connection ---
  {
    ...
    content: 'Connecting Meta Business enables CampaignAI to publish posts directly to Facebook Pages and Instagram Business accounts, manage Meta ad campaigns, capture leads from Lead Gen forms, and pull real-time campaign insights.',
    steps: [
  ...
  // --- 5. Campaign Creation ---
  {
    ...
    content: 'CampaignAI allows you to create high-converting Meta ad campaigns in minutes using the AI Campaign Generator or step-by-step Campaign Wizard. AI automatically generates persuasive ad copy, catchy headlines, call-to-action buttons, target audience recommendations, and daily budget allocations based on your onboarding profile.',
    steps: [
  ...
  // --- 8. Analytics & Reports ---
  {
    ...
    content: 'CampaignAI Analytics provides in-depth reporting on your marketing campaigns: Summary performance metrics, Demographic breakdown (Gender: Male/Female/Unknown, Age groups: 18-24, 25-34, 35-44, 45-54, 55-64, 65+), Platform breakdown (Facebook vs Instagram performance), and daily performance trends.',
    steps: [
  ...
  // --- 10. Subscription Plans ---
  {
    ...
    content: 'CampaignAI offers flexible subscription plans tailored to business size: Free Tier (basic campaigns, limited content generation, manual export) and Premium Tiers (unlimited AI campaign generation, full Content Calendar, AI Lead Assistant, auto-publishing, advanced analytics, priority support).',
    steps: [
  ...
  // --- 11. Support Tickets & Help Assistant ---
  {
    ...
    content: 'If you encounter an issue or have a complex technical request, you can submit a Support Ticket directly through the platform. Track your ticket status (Open, In Progress, Resolved) and receive updates from the CampaignAI support team.',
    steps: [
    ...
    nextSteps: 'You can also ask the CampaignAI Help Bot anytime from the floating bottom-left chat icon!'
  },
  ...
  // --- 12. Troubleshooting & FAQs ---
  {
    ...
    steps: [
      ...
      'For general questions about features, ask the CampaignAI Help Bot in the chat drawer.'
    ],
...
# CampaignAI — Official Platform Documentation & RAG Knowledge Base
...
- **CampaignAI Help Bot**: Official floating support assistant available 24/7.
`;
